...
\verbatiminput{../functions/modifiedNewtonMethod.m}%a
\section{}
Il codice della \textit{function} è contenuto nel file \texttt{mialu.m}:\\
\verbatiminput{../functions/mialu.m}%a
...
\verbatiminput{../functions/mialdl.m}%a
...
\verbatiminput{../functions/miaqr.m}
...
\section{}
La funzione è contenuta nel file \texttt{newton\_14.m}.
\verbatiminput{../functions/newton_14.m}%a
\section{Q}
\end{document}
