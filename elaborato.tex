...
I dati sul confronto tra il  risultato offerto dalla funzione e il valore \texttt{x\^ (1/6)} sono contentuti nel file \texttt{table\_5.txt}:
\verbatiminput{functions/table_5.txt}
\section{}
...
Il metodo di Newton esegue due valutazioni iniziali e poi due in ogni iterazione.\\
Sia $n$ il numero di iterazioni, il costo computazionale del metodo di Newton è dato da $2(n+1)$.\\
Il metodo delle secanti esegue due valutazioni iniziali e poi una per ogni iterazioni, quindi il suo costo computazionale è dato da $n+2$.
\begin{center}
